...
<body>
            ...
            <div class="yot-flex yot-flex-fd-c">
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="manage-pao" class="yot-text-fs-l yot-tc-white yot-mb-16 yot-nav-active">Manage Mpuj Pao</a>
        ...
        <section style="width: 100%; margin-top: 80px; position: relative;" class="yot-container yot-right-container dashboard-section-rightF">
            ...
            <div class="yot-row yot-flex-ai-c-jc-sb yot-text-fs-xl ">
                ...
                <div class="yot-flex">
                    <!-- PDF -->
                    <div class="yot-mr-8">
                        <a target="_blank" href="./asset/php/helper/pdf/pdf-staff-pao.php" style="font-size: 18px;" class="yot-btn-primary remove-hover">Print PDF</a>
                    </div>

                    <!-- Btn Pao -->
                    <div>
                        <button id="btnPao" style="font-size: 16.5px;" class="yot-btn-primary">Add PAO</button>
                    </div>
                </div>
            </div>
    ...
    <script src="./asset/js/ajax/pao-search-name-date.js"></script>
</body>
</html>