...
<body>
            ...
            <div class="yot-flex yot-flex-fd-c">
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="trad" class="yot-text-fs-l yot-tc-white yot-mb-16 yot-nav-active">Manage Trad</a>
        ...
        <section style="width: 100%; margin-top: 80px; position: relative; z-index: 2;" class="dashboard-section-rightF yot-container yot-right-container">
            ...
            <div class="yot-row yot-flex-ai-c-jc-sb yot-text-fs-xl ">
                ...
                <div class="yot-flex">
                    <!-- PDF -->
                    <div class="yot-mr-8">
                        <a target="_blank" href="./asset/php/helper/pdf/pdf-trad-info" style="font-size: 18px;" class="yot-btn-primary remove-hover">Print PDF</a>
                    </div>
             ...
             <div id="createAccountContainer" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                ...
                <!-- Form -->
                <form id="formTradInfo" style=" overflow-x: auto;margin-top:24px;">
            ...
            <!-- Edit trad Info-->
            <div id="editTradContainer"></div>

            <!-- Delete trad Info -->
            <div id="deleteTradContainer"></div>
            ...
            <div style=" overflow-y: auto; height: 500px;">
                <table class="yot-styled-table">
                    ...
                    <tbody class="displayTrad">
                    </tbody>

                    <?php
                        // require_once("./asset/php/main/display-trad-info.php");
    ...
    <script src="./asset/js/ajax/insert-trad-info.js"></script>
    <script src="./asset/js/ajax/edit-trad-info.js"></script>
    <script src="./asset/js/ajax/delete-trad-info.js"></script>

    <script src="./asset/js/ajax/display-edit-trad-info.js"></script>
    <script src="./asset/js/ajax/display-delete-trad-info.js"></script>

    <script src="./asset/js/ajax/trad-search-name-date.js"></script>
</body>
</html>