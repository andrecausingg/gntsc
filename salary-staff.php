...
<head>
    ...
    <title>GNTSC - Staff Salary</title>
...
<body>
            ...
            <div class="yot-flex yot-flex-fd-c">
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="salary-staff" class="yot-text-fs-l yot-mb-16 yot-tc-white yot-nav-active">Manage Staff Salary</a>
        ...
        <section style="width: 100%; margin-top: 80px; position: relative; z-index: 2;" class="dashboard-section-rightF yot-container yot-right-container">
            ...
            <div class="yot-row yot-flex-ai-c-jc-sb yot-text-fs-xl ">
                ...
                <div class="yot-flex">
                    ...
                    <div class="yot-ml-8">
                        <button id="btnComputeStaff" style="font-size: 20px;" class="yot-btn-primary">Compute</button>
                    </div>
                </div>
            </div>

            <!-- Salary Computation Staff-->
            <div id="salaryStaffCompute" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                <!-- Computation Staff -->
                <div class="yot-mb-16 yot-bg-white yot-pa-24 yot-bg-sea-of-tears yot-tc-white" style="margin-top: -30px; border-radius: 8px;">
                    <div class="yot-flex yot-flex-ai-c-jc-sb">
                        <h3>Computation for Staff</h3> <br>
                        <i class="fa-solid fa-circle-xmark closeBtn yot-cursor-pointer" style="font-size: 24px;"></i>
                    </div>
                </div>

                <!-- Form -->
                <form id="formSalaryStaff" style=" overflow-x: auto; margin-top:24px;">
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Staff Name</b></label>
                            <select class="yot-form-input driverNameStaff" name="driverNameTrad" id="driverNameTrad">
                                <?php
                                    require_once("./asset/php/main/display-puj-pao.php");
                                    $classDisplayPujPao = new classDisplayPujPao();
                                    $classDisplayPujPao->displaySta();
                                ?>
                            </select>
                            <span class="yot-tc-red errDriverNameStaff" style="display: none;"><b>The Driver field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>No. of Days</b></label>
                            <input class="yot-form-input numDaysStaff" type="text" name="numDaysStaff" id="numDaysStaff">
                        ...
                        <div class="yot-form-group">
                            ...
                            <input class="yot-form-input rateStaff" type="text" name="rateStaff" id="rateStaff">
                            <span class="yot-tc-red errRateStaff" style="display: none;"><b>The Rate field is required.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            ...
                            <input class="yot-form-input amountStaff" style="background: #CCC; color: #333; font-weight:bolder; border: 1px solid #666 " type="text" name="amountStaff" id="amountStaff" disabled>
                        </div>
                    </div>
            ...
            <!-- Edit Salary Computation Staff-->
            <div id="salaryStaffComputeEdit"></div>
            
            <!-- Delete Salary Computation Staff -->
            <div id="deleteContainerStaff"></div>
            ...
            <div style=" overflow-y: auto; height: 500px;">
                <table class="yot-styled-table">
                    ...
                    <tbody class="displayStaffSalary">
                    </tbody>
                </table>
            </div>
            ...
            <div class="butawFormPdfContainer dashboard-edit-update-container yot-bg-white" style="display: none;">
                ...
                <div class="yot-mb-16 yot-bg-white yot-pa-24 yot-bg-sea-of-tears yot-tc-white" style="margin-top: -30px; border-radius: 8px;">
                    <div class="yot-flex yot-flex-ai-c-jc-sb">
                        <h3>Creating Staff Report</h3> <br>
                        <i class="fa-solid fa-circle-xmark closeBtn yot-cursor-pointer" style="font-size: 24px;"></i>
                    </div>
                </div>

                <!-- Form -->
                <form method="post" action="./asset/php/helper/pdf/pdf-salary-staff.php">
    ...
    <script src="./asset/js/function-hml/edit-delete.js"></script>
     ...
     <script src="./asset/js/ajax/insert-staff-salary.js"></script>
     <script src="./asset/js/ajax/delete-salary-staff.js"></script>
     <script src="./asset/js/ajax/edit-staff-salary.js"></script>

     <script src="./asset/js/ajax/display-delete-salary-staff.js"></script>
     <script src="./asset/js/ajax/display-edit-salary-staff.js"></script>
     
     <script src="./asset/js/ajax/staff-salary-search-name-date.js"></script>
