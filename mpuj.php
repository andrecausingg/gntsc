...
<body>
    ...
    <div class="dashboard-container">
        <!-- Left Section -->
        <section id="navLeftContainer" class="yot-ma-16 yot-pa-16 yot-bg-sea-of-tears dashboard-right-section yot-hide-for-mobile yot-overlay-left" style="height: 95vh; width:300px; border-radius:10px; z-index: 3; overflow-y: auto;">
            <div class="yot-flex yot-flex-fd-c">
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="mpuj" class="yot-text-fs-l yot-tc-white yot-mb-16 yot-nav-active">Manage Mpuj</a>
        ...
        <section style="width: 100%; margin-top: 80px; position: relative; z-index: 2;" class="dashboard-section-rightF yot-container yot-right-container">
            ...
            <div class="yot-row yot-flex-ai-c-jc-sb yot-text-fs-xl ">
                ...
                <div>
                    <div class="yot-form-group">
                        ...
                        <input class="yot-form-input" type="text" name="searchName" id="searchName" placeholder="Search">
                    </div>
                </div>
                ...
                <div class="yot-flex">
                    <!-- PDF -->
                    <div class="yot-mr-8">
                        <a target="_blank" href="./asset/php/helper/pdf/pdf-mpuj-info" style="font-size: 18px;" class="yot-btn-primary remove-hover">Print PDF</a>
                    </div>

                    <!-- Btn -->
                    <div>
                        <button id="btnCreateAccount" style="font-size: 16.5px;" class="yot-btn-primary">Create</button>
                    </div>
                </div>
            </div>
             ...
             <div id="createAccountContainer" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                <div class="yot-mb-16 yot-bg-white yot-pa-24 yot-bg-sea-of-tears yot-tc-white" style="margin-top: -30px; border-radius: 8px;">
                    <div class="yot-flex yot-flex-ai-c-jc-sb">
                        <h3>Adding MPUJ Info</h3> <br>
                        <i class="fa-solid fa-circle-xmark closeBtn yot-cursor-pointer" style="font-size: 24px;"></i>
                    </div>
                </div>

                <!-- Form -->
                <form id="formMpujInfo" style=" overflow-x: auto;margin-top:24px;">
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Chasis No.</b></label>
                            <input class="yot-form-input chasisNum" type="text" name="chasisNum" id="chasisNum">
                            <span class="yot-tc-red errchasisNum" style="display: none;"><b>The Chasis No. field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Plate No.</b></label>
                            <input class="yot-form-input plateNum" type="text" name="plateNum" id="plateNum">
                            <span class="yot-tc-red errPlateNum" style="display: none;"><b>The Plate No. field is required.</b></span>
                        </div>

                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Mpuj No.</b></label>
                            <input class="yot-form-input mpujNum" type="text" name="mpujNum" id="mpujNum">
                            <span class="yot-tc-red errmpujNum" style="display: none;"><b>The Mpuj No. field is required.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            ...
                            <input class="yot-form-input engineNum" type="text" name="engineNum" id="engineNum">
                            <span class="yot-tc-red errEngineNum" style="display: none;"><b>The Engine No. field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Status</b></label>
                            <select class="yot-form-input" name="status" id="status" style="width: 200px;">
            ...
            <div style=" overflow-y: auto; height: 500px;">
                <table class="yot-styled-table">
                    ...
                    <tbody class="displayMpuj">

                        <?php
                            // require_once("./asset/php/main/display-mpuj-info.php");
    ...
    <script src="./asset/js/ajax/mpuj-search-name-date.js"></script>
</body>
</html>