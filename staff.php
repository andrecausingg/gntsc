...
<head>
    ...
    <title>GNTSC - Staff Information</title>
    ...
    <div class="dashboard-container">
        ...
        <section id="navLeftContainer" class="yot-ma-16 yot-pa-16 yot-bg-sea-of-tears dashboard-right-section yot-hide-for-mobile yot-overlay-left" style="height: 95vh; width:300px; border-radius:10px; z-index: 2; overflow-y: auto;">
            <div class="yot-flex yot-flex-fd-c">
                ...
                <div class="yot-flex yot-flex-ai-c-jc-sb dashboard-logo">
                    <div>
                        <h2 class="yot-tc-white">GNTSC</h1>
                    </div>
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="staff" class="yot-text-fs-l yot-tc-white yot-nav-active yot-mb-16">Staff Info</a>
                        <a href="mpuj" class="yot-text-fs-l yot-tc-white yot-mb-16">Mpuj Info</a>
                        <a href="trad" class="yot-text-fs-l yot-tc-white yot-mb-16">Trad Info</a>
                        <a href="dispatch" class="yot-text-fs-l yot-tc-white">Dispatch</a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        <a href="salary-mpuj" class="yot-text-fs-l yot-mb-16 yot-tc-white">Salary Mpuj</a>
                        <a href="salary-trad" class="yot-text-fs-l yot-tc-white">Salary Trad</a>
                        <!--<a href="attendance" class="yot-text-fs-l yot-tc-white">Attendance</a>-->
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="accounts" class="yot-text-fs-l yot-mb-16 yot-tc-white">Accounts</a>
        ...
        <section style="width: 100%; margin-top: 80px; position: relative;" class="yot-container yot-right-container dashboard-section-rightF">
            ...
            <div class="yot-flex yot-flex-ai-c-jc-e yot-text-end yot-text-fs-xl yot-mt-16">
                <!-- PDF -->
                <div class="yot-mr-8  yot-hide-for-mobile">
                    <a target="_blank" href="./asset/php/helper/pdf/pdf-staff" style="font-size: 18px;" class="yot-btn-primary remove-hover">Print PDF</a>
                </div>

                <!-- Btn Puj -->
                <div>
                    <button id="btnPuj" style="font-size: 18px;" class="yot-btn-primary">Add PUJ</button>
                </div>

                <!-- Btn Pao -->
                <div  class="yot-mlr-8">
                    <button id="btnPao" style="font-size: 18px;" class="yot-btn-primary">Add PAO</button>
                </div>

                <!-- Btn Ins -->
                <div>
                    <button id="btnIns" style="font-size: 18px;" class="yot-btn-primary">Add INS</button>
                </div>
            </div>

            <!--  -->
            <div class="yot-flex yot-flex-ai-c-jc-e yot-text-end yot-text-fs-xl yot-mt-16 yot-hide-for-desktop">
                <!-- PDF -->
                <div class="yot-mr-8">
                    <a target="_blank" href="./asset/php/helper/pdf/pdf-staff.php" style="font-size: 18px;" class="yot-btn-primary remove-hover">Print PDF</a>
                </div>
            </div>
            ...
            <div id="addPujContainer" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                ...
                <!-- Form -->
                <form id="formPuj" style=" overflow-x: auto; height: 600px; margin-top:24px;">
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Role</b></label>
                            <input class="yot-form-input" type="text" name="roleName" id="roleName" value="PUJ" disabled>
                        </div>
                    </div>
            ...
            <!-- Edit Puj -->
            <div id="editPujContainerDisplay"></div>

            <!-- Add PAO-->
            <div id="addPaoContainer" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                <div class="yot-bg-vibrant-orange yot-pa-24 yot-flex yot-flex-ai-c-jc-sb yot-tc-white" style=" border-radius: 8px; margin-top:-30px;">
                    <div>
                        <h4>Adding PAO Information</h4>
                    </div>
                ...
                <!-- Form -->
                <form id="formPao" style=" overflow-x: auto; height: 600px; margin-top:24px;">
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Role</b></label>
                            <input class="yot-form-input" type="text" name="roleNamePao" id="roleNamePao" value="PAO" disabled>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Last Name</b></label>
                            <input class="yot-form-input lNamePao" type="text" name="lastNamePao" id="lastNamePao">
                            <span class="yot-tc-red errLnamePao" style="display: none;"><b>The Last Name field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Middle Name</b></label>
                            <input class="yot-form-input" type="text" name="middleNamePao" id="middleNamePao">
                        </div>

                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>First Name</b></label>
                            <input class="yot-form-input fNamePao" type="text" name="firstNamePao" id="firstNamePao">
                            <span class="yot-tc-red errFnamePao" style="display: none;"><b>The First Name field is required.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Birth Date</b></label>
                            <div class="yot-flex">
                                <select class="yot-form-input" name="birthMonthPao" id="birthMonthPao" style="width: 150px;">
                                    <option value="1">Jan</option><option value="2">Feb</option><option value="3">Mar</option><option value="4">Apr</option><option value="5">May</option><option value="6">Jun</option><option value="7">Jul</option><option value="8">Aug</option><option value="9">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dec</option>
                                </select>

                                <select class="yot-form-input yot-form-select-seperator" name="birthDayPao" id="birthDayPao" style="width: 150px;">
                                    <option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option>
                                </select>

                                <select class="yot-form-input birthYearPao" name="birthYearPao" id="birthYearPao" style="width: 150px;">
                                    <option value="2022">2022</option><option value="2021">2021</option><option value="2020">2020</option><option value="2019">2019</option><option value="2018">2018</option><option value="2017">2017</option><option value="2016">2016</option><option value="2015">2015</option><option value="2014">2014</option><option value="2013">2013</option><option value="2012">2012</option><option value="2011">2011</option><option value="2010">2010</option><option value="2009">2009</option><option value="2008">2008</option><option value="2007">2007</option><option value="2006">2006</option><option value="2005">2005</option><option value="2004">2004</option><option value="2003">2003</option><option value="2002">2002</option><option value="2001">2001</option><option value="2000">2000</option><option value="1999">1999</option><option value="1998">1998</option><option value="1997">1997</option><option value="1996">1996</option><option value="1995">1995</option><option value="1994">1994</option><option value="1993">1993</option><option value="1992">1992</option><option value="1991">1991</option><option value="1990">1990</option><option value="1989">1989</option><option value="1988">1988</option><option value="1987">1987</option><option value="1986">1986</option><option value="1985">1985</option><option value="1984">1984</option><option value="1983">1983</option><option value="1982">1982</option><option value="1981">1981</option><option value="1980">1980</option><option value="1979">1979</option><option value="1978">1978</option><option value="1977">1977</option><option value="1976">1976</option><option value="1975">1975</option><option value="1974">1974</option><option value="1973">1973</option><option value="1972">1972</option><option value="1971">1971</option><option value="1970">1970</option><option value="1969">1969</option><option value="1968">1968</option><option value="1967">1967</option><option value="1966">1966</option><option value="1965">1965</option><option value="1964">1964</option><option value="1963">1963</option><option value="1962">1962</option><option value="1961">1961</option><option value="1960">1960</option><option value="1959">1959</option><option value="1958">1958</option><option value="1957">1957</option><option value="1956">1956</option><option value="1955">1955</option><option value="1954">1954</option><option value="1953">1953</option><option value="1952">1952</option><option value="1951">1951</option><option value="1950">1950</option><option value="1949">1949</option><option value="1948">1948</option><option value="1947">1947</option><option value="1946">1946</option><option value="1945">1945</option><option value="1944">1944</option><option value="1943">1943</option><option value="1942">1942</option><option value="1941">1941</option><option value="1940">1940</option><option value="1939">1939</option><option value="1938">1938</option><option value="1937">1937</option><option value="1936">1936</option><option value="1935">1935</option><option value="1934">1934</option><option value="1933">1933</option><option value="1932">1932</option><option value="1931">1931</option><option value="1930">1930</option><option value="1929">1929</option><option value="1928">1928</option><option value="1927">1927</option><option value="1926">1926</option><option value="1925">1925</option><option value="1924">1924</option><option value="1923">1923</option><option value="1922">1922</option><option value="1921">1921</option><option value="1920">1920</option><option value="1919">1919</option><option value="1918">1918</option><option value="1917">1917</option><option value="1916">1916</option><option value="1915">1915</option><option value="1914">1914</option><option value="1913">1913</option><option value="1912">1912</option><option value="1911">1911</option><option value="1910">1910</option><option value="1909">1909</option><option value="1908">1908</option><option value="1907">1907</option><option value="1906">1906</option><option value="1905">1905</option>
                                </select>
                            </div>
                            <span class="yot-tc-red errAgePao" style="display: none;"><b>The Age Must 18 Above.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Birth Place</b></label>
                            <input class="yot-form-input birthPlacePao" type="text" name="birthPlacePao" id="birthPlacePao">
                            <span class="yot-tc-red errBirthPlacePao" style="display: none;"><b>The Birth Place field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Gender</b></label>
                            <select class="yot-form-input" name="genderPao" id="genderPao" style="width: 150px;">
                                <option value="Male">Male</option>
                                <option value="Female">Female</option>
                            </select>
                        </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Civil Status</b></label>
                            <select class="yot-form-input" name="civilStatusPao" id="civilStatusPao" style="width: 150px;">
                                <option value="Single">Single</option>
                                <option value="Married">Married</option>
                                <option value="Widow">Widow</option>
                                <option value="Seperated">Seperated</option>
                        ...
                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Address</b></label>
                            <input class="yot-form-input addressPao" type="text" name="addressPao" id="addressPao">
                            <span class="yot-tc-red errAddressPao" style="display: none;"><b>The Address field is required.</b></span>
                        </div>

                        <div class="yot-form-group ">
                            <label for="" class="yot-text-fs-m"><b>Contact Number</b></label>
                            <input class="yot-form-input contactNumberPao" type="text" name="contactNumberPao" id="contactNumberPao">
                            <span class="yot-tc-red errContactNumberPao" style="display: none;"><b>The Contact Number field is required.</b></span>
                            <span class="yot-tc-red errContactNumberLessMorethanPao" style="display: none;"><b>The Contact Number must 11 Digit.</b></span>
                        </div>
                    </div>
            ...
            <!-- Edit Pao -->
            <div id="editPaoContainerDisplay"></div>

            <!-- Add INS-->
            <div id="addInsContainer" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                <div class="yot-bg-vibrant-orange yot-pa-24 yot-flex yot-flex-ai-c-jc-sb yot-tc-white" style=" border-radius: 8px; margin-top:-30px;">
                    <div>
                        <h4>Adding INS Information</h4>
                    </div>
                ...
                <!-- Form -->
                <form id="formIns" style=" overflow-x: auto; height: 600px; margin-top:24px;">
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Role</b></label>
                            <input class="yot-form-input" type="text" name="roleNameIns" id="roleNameIns" value="INS" disabled>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Last Name</b></label>
                            <input class="yot-form-input lNameIns" type="text" name="lastNameIns" id="lastNameIns">
                            <span class="yot-tc-red errLnameIns" style="display: none;"><b>The Last Name field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Middle Name</b></label>
                            <input class="yot-form-input" type="text" name="middleNameIns" id="middleNameIns">
                        </div>

                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>First Name</b></label>
                            <input class="yot-form-input fNameIns" type="text" name="firstNameIns" id="firstNameIns">
                            <span class="yot-tc-red errFnameIns" style="display: none;"><b>The First Name field is required.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Birth Date</b></label>
                            <div class="yot-flex">
                                <select class="yot-form-input" name="birthMonthIns" id="birthMonthIns" style="width: 150px;">
                                    <option value="1">Jan</option><option value="2">Feb</option><option value="3">Mar</option><option value="4">Apr</option><option value="5">May</option><option value="6">Jun</option><option value="7">Jul</option><option value="8">Aug</option><option value="9">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dec</option>
                                </select>

                                <select class="yot-form-input yot-form-select-seperator" name="birthDayIns" id="birthDayIns" style="width: 150px;">
                                    <option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option>
                                </select>

                                <select class="yot-form-input birthYearIns" name="birthYearIns" id="birthYearIns" style="width: 150px;">
                                    <option value="2022">2022</option><option value="2021">2021</option><option value="2020">2020</option><option value="2019">2019</option><option value="2018">2018</option><option value="2017">2017</option><option value="2016">2016</option><option value="2015">2015</option><option value="2014">2014</option><option value="2013">2013</option><option value="2012">2012</option><option value="2011">2011</option><option value="2010">2010</option><option value="2009">2009</option><option value="2008">2008</option><option value="2007">2007</option><option value="2006">2006</option><option value="2005">2005</option><option value="2004">2004</option><option value="2003">2003</option><option value="2002">2002</option><option value="2001">2001</option><option value="2000">2000</option><option value="1999">1999</option><option value="1998">1998</option><option value="1997">1997</option><option value="1996">1996</option><option value="1995">1995</option><option value="1994">1994</option><option value="1993">1993</option><option value="1992">1992</option><option value="1991">1991</option><option value="1990">1990</option><option value="1989">1989</option><option value="1988">1988</option><option value="1987">1987</option><option value="1986">1986</option><option value="1985">1985</option><option value="1984">1984</option><option value="1983">1983</option><option value="1982">1982</option><option value="1981">1981</option><option value="1980">1980</option><option value="1979">1979</option><option value="1978">1978</option><option value="1977">1977</option><option value="1976">1976</option><option value="1975">1975</option><option value="1974">1974</option><option value="1973">1973</option><option value="1972">1972</option><option value="1971">1971</option><option value="1970">1970</option><option value="1969">1969</option><option value="1968">1968</option><option value="1967">1967</option><option value="1966">1966</option><option value="1965">1965</option><option value="1964">1964</option><option value="1963">1963</option><option value="1962">1962</option><option value="1961">1961</option><option value="1960">1960</option><option value="1959">1959</option><option value="1958">1958</option><option value="1957">1957</option><option value="1956">1956</option><option value="1955">1955</option><option value="1954">1954</option><option value="1953">1953</option><option value="1952">1952</option><option value="1951">1951</option><option value="1950">1950</option><option value="1949">1949</option><option value="1948">1948</option><option value="1947">1947</option><option value="1946">1946</option><option value="1945">1945</option><option value="1944">1944</option><option value="1943">1943</option><option value="1942">1942</option><option value="1941">1941</option><option value="1940">1940</option><option value="1939">1939</option><option value="1938">1938</option><option value="1937">1937</option><option value="1936">1936</option><option value="1935">1935</option><option value="1934">1934</option><option value="1933">1933</option><option value="1932">1932</option><option value="1931">1931</option><option value="1930">1930</option><option value="1929">1929</option><option value="1928">1928</option><option value="1927">1927</option><option value="1926">1926</option><option value="1925">1925</option><option value="1924">1924</option><option value="1923">1923</option><option value="1922">1922</option><option value="1921">1921</option><option value="1920">1920</option><option value="1919">1919</option><option value="1918">1918</option><option value="1917">1917</option><option value="1916">1916</option><option value="1915">1915</option><option value="1914">1914</option><option value="1913">1913</option><option value="1912">1912</option><option value="1911">1911</option><option value="1910">1910</option><option value="1909">1909</option><option value="1908">1908</option><option value="1907">1907</option><option value="1906">1906</option><option value="1905">1905</option>
                                </select>
                            </div>
                            <span class="yot-tc-red errAgeIns" style="display: none;"><b>The Age Must 18 Above.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Birth Place</b></label>
                            <input class="yot-form-input birthPlaceIns" type="text" name="birthPlaceIns" id="birthPlaceIns">
                            <span class="yot-tc-red errBirthPlaceIns" style="display: none;"><b>The Birth Place field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Gender</b></label>
                            <select class="yot-form-input" name="genderIns" id="genderIns" style="width: 150px;">
                                <option value="Male">Male</option>
                                <option value="Female">Female</option>
                            </select>
                        </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Civil Status</b></label>
                            <select class="yot-form-input" name="civilStatusIns" id="civilStatusIns" style="width: 150px;">
                                <option value="Single">Single</option>
                                <option value="Married">Married</option>
                                <option value="Widow">Widow</option>
                                <option value="Seperated">Seperated</option>
                        ...
                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Address</b></label>
                            <input class="yot-form-input addressIns" type="text" name="addressIns" id="addressIns">
                            <span class="yot-tc-red errAddressIns" style="display: none;"><b>The Address field is required.</b></span>
                        </div>

                        <div class="yot-form-group ">
                            <label for="" class="yot-text-fs-m"><b>Contact Number</b></label>
                            <input class="yot-form-input contactNumberIns" type="text" name="contactNumberIns" id="contactNumberIns">
                            <span class="yot-tc-red errContactNumberIns" style="display: none;"><b>The Contact Number field is required.</b></span>
                            <span class="yot-tc-red errContactNumberLessMorethanIns" style="display: none;"><b>The Contact Number must 11 Digit.</b></span>
                        </div>
                    </div>
            ...
            <!-- Edit Ins -->
            <div id="editInsContainerDisplay"></div>
