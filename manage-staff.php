...
<head>
    ...
    <title>GNTSC - Manage Staff</title>
...
<body>
            ...
            <div class="yot-flex yot-flex-fd-c">
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="manage-staff" class="yot-text-fs-l yot-tc-white yot-mb-16 yot-nav-active">Manage Staff</a>
        ...
        <section style="width: 100%; margin-top: 80px; position: relative;" class="yot-container yot-right-container dashboard-section-rightF">
            ...
            <div class="yot-row yot-flex-ai-c-jc-sb yot-text-fs-xl ">
                ...
                <div class="yot-flex">
                    <!-- PDF -->
                    <div class="yot-mr-8">
                        <a target="_blank" href="./asset/php/helper/pdf/pdf-staff-staff.php" style="font-size: 18px;" class="yot-btn-primary remove-hover">Print PDF</a>
                    </div>

                    <!-- Btn Ins -->
                    <div>
                        <button id="btnIns" style="font-size: 16.5px;" class="yot-btn-primary">Add Staff</button>
                    </div>
                </div>
            </div>
            ...
            <div id="addInsContainer" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                <div class="yot-bg-vibrant-orange yot-pa-24 yot-flex yot-flex-ai-c-jc-sb yot-tc-white" style=" border-radius: 8px; margin-top:-30px;">
                    <div>
                        <h4>Adding Staff Information</h4>
                    </div>
                ...
                <form id="formIns" style=" overflow-x: auto; height: 600px; margin-top:24px;">
                    <div class="yot-flex-tab">
                        <div class="yot-form-group" style="display: none;">
                            ...
                            <input class="yot-form-input" type="text" name="roleNameIns" id="roleNameIns" value="STA" disabled>
                        </div>

                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Position</b></label>
                            <input class="yot-form-input positionIns" type="text" name="positionIns" id="positionIns">
                            <span class="yot-tc-red errPositionIns" style="display: none;"><b>The Position field is required.</b></span>
                        </div>
                    </div>
    ...
    <script src="./asset/js/ajax/staff-search-name-date.js"></script>
</body>
</html>