...
<head>
    ...
    <title>GNTSC - Manage Operator</title>
...
<body>
            ...
            <div class="yot-flex yot-flex-fd-c">
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="manage-operator" class="yot-text-fs-l yot-tc-white yot-mb-16 yot-nav-active">Manage Mpuj Operators</a>
        ...
        <section style="width: 100%; margin-top: 80px; position: relative;" class="dashboard-section-rightF yot-container yot-right-container">
            ...
            <div class="yot-row yot-flex-ai-c-jc-sb yot-text-fs-xl ">
                ...
                <div>
                    <div class="yot-form-group">
                        ...
                        <input class="yot-form-input" type="text" name="searchName" id="searchName" placeholder="Search Name">
                    </div>
                </div>
                ...
                <div class="yot-flex">
                    <!-- PDF -->
                    <div class="yot-mr-8">
                        <a target="_blank" href="./asset/php/helper/pdf/pdf-staff-ope" style="font-size: 18px;" class="yot-btn-primary remove-hover">Print PDF</a>
                    </div>

                    <!-- Btn Puj -->
                    <div>
                        <button id="btnIns" style="font-size: 16.5px;" class="yot-btn-primary">Add OPERATORS</button>
                    </div>
                </div>
            </div>
            ...
            <div id="addInsContainer" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                <div class="yot-bg-vibrant-orange yot-pa-24 yot-flex yot-flex-ai-c-jc-sb yot-tc-white" style=" border-radius: 8px; margin-top:-30px;">
                    <div>
                        <h4>Adding Operator Information</h4>
                    </div>
                ...
                <!-- Form -->
                <form id="formOpe" style=" overflow-x: auto; height: 600px; margin-top:24px;">
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>Role</b></label>
                            <input class="yot-form-input" type="text" name="roleNameOpe" id="roleNameOpe" value="OPE" disabled>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            ...
                            <input class="yot-form-input lNameOpe" type="text" name="lastNameOpe" id="lastNameOpe">
                            <span class="yot-tc-red errLnameOpe" style="display: none;"><b>The Last Name field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Middle Name</b></label>
                            <input class="yot-form-input" type="text" name="middleNameOpe" id="middleNameOpe">
                        </div>

                        <div class="yot-form-group">
                            <label for="" class="yot-text-fs-m"><b>First Name</b></label>
                            <input class="yot-form-input fNameOpe" type="text" name="firstNameOpe" id="firstNameOpe">
                            <span class="yot-tc-red errFnameOpe" style="display: none;"><b>The First Name field is required.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            ...
                            <div class="yot-flex">
                                <select class="yot-form-input" name="birthMonthOpe" id="birthMonthOpe" style="width: 150px;">
                                ...
                                <select class="yot-form-input yot-form-select-seperator" name="birthDayOpe" id="birthDayOpe" style="width: 150px;">
                                ...
                                <select class="yot-form-input birthYearOpe" name="birthYearOpe" id="birthYearOpe" style="width: 150px;">
                            ...
                            <span class="yot-tc-red errAgeOpe" style="display: none;"><b>The Age Must 18 Above.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            ...
                            <input class="yot-form-input birthPlaceOpe" type="text" name="birthPlaceOpe" id="birthPlaceOpe">
                            <span class="yot-tc-red errBirthPlaceOpe" style="display: none;"><b>The Birth Place field is required.</b></span>
                        </div>

                        <div class="yot-form-group yot-form-input-seperator">
                            <label for="" class="yot-text-fs-m"><b>Gender</b></label>
                            <select class="yot-form-input" name="genderOpe" id="genderOpe" style="width: 150px;">
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            ...
                            <select class="yot-form-input" name="civilStatusOpe" id="civilStatusOpe" style="width: 150px;">
                        ...
                        <div class="yot-form-group yot-form-input-seperator">
                            ...
                            <input class="yot-form-input addressOpe" type="text" name="addressOpe" id="addressOpe">
                            <span class="yot-tc-red errAddressOpe" style="display: none;"><b>The Address field is required.</b></span>
                        </div>

                        <div class="yot-form-group ">
                            <label for="" class="yot-text-fs-m"><b>Contact Number</b></label>
                            <input class="yot-form-input contactNumberOpe" type="text" name="contactNumberOpe" id="contactNumberOpe">
                            <span class="yot-tc-red errContactNumberOpe" style="display: none;"><b>The Contact Number field is required.</b></span>
                            <span class="yot-tc-red errContactNumberLessMorethanOpe" style="display: none;"><b>The Contact Number must 11 Digit.</b></span>
                        </div>
                    </div>
                    ...
                    <div class="yot-flex-tab">
                        <div class="yot-form-group">
                            ...
                            <input class="yot-form-input plateNumOpe" type="text" name="plateNumOpe" id="plateNumOpe">
                            <span class="yot-tc-red errPlateNumOpe" style="display: none;"><b>The Plate No. field is required.</b></span>
                        </div>
                    </div>
            ...
            <!-- Edit Ope -->
            <div id="editOpeContainerDisplay"></div>
    ...
    <script src="./asset/js/ajax/ope-search-name-date.js"></script>
</body>
</html>