...
<body>
            ...
            <div class="yot-flex yot-flex-fd-c">
                ...
                <div>
                    ...
                    <div class="yot-flex yot-flex-fd-c-ai-c yot-mtb-16">
                        ...
                        <a href="manage-driver" class="yot-text-fs-l yot-tc-white yot-mb-16 yot-nav-active">Manage Mpuj Driver</a>
        ...
        <section style="width: 100%; margin-top: 80px; position: relative;" class="dashboard-section-rightF yot-container yot-right-container">
            ...
            <div class="yot-row yot-flex-ai-c-jc-sb yot-text-fs-xl ">
                ...
                <div class="yot-flex">
                    <!-- PDF -->
                    <div class="yot-mr-8">
                        <a target="_blank" href="./asset/php/helper/pdf/pdf-staff-puj" style="font-size: 18px;" class="yot-btn-primary remove-hover">Print PDF</a>
                    </div>
            ...
            <div id="addPujContainer" class="dashboard-edit-update-container yot-bg-white" style="display: none;">
                <div class="yot-bg-vibrant-orange yot-pa-24 yot-flex yot-flex-ai-c-jc-sb yot-tc-white" style=" border-radius: 8px; margin-top:-30px;">
                    <div>
                        <h4>Adding Mpuj Driver Information</h4>
                    </div>
    ...
    <script src="./asset/js/ajax/mpuj-puj-search-name-date.js"></script>
</body>
</html>