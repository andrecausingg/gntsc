<?php
    ...
    $html = '
        ...
        <h3 style="text-align:center">INSPECTOR</h3>
    ';
    ...
    $html .= '
        <table style="border-collapse: collapse; width: 100%;">
            <thead>
                <tr>
                    <th style="padding: 4px; text-align: center;border-bottom: 1px solid #ddd;">Role</th>
    ...
    $fetch_data = mysqli_query($classDataBaseConnection->connect(), "SELECT * FROM staff_info_tbl WHERE sit_role_name ='INS' ORDER BY sit_id DESC");
    while($row = mysqli_fetch_assoc($fetch_data)){
        ...
        $html .= '
            <tbody>
                <tr>
                    <td style="padding: 4px; text-align: center;border-bottom: 1px solid #ddd;">'. $db_sit_role_name .'</td>
                    ...
                    <td style="padding: 4px; text-align: center;border-bottom: 1px solid #ddd;">' . $db_sit_license .'</td>
