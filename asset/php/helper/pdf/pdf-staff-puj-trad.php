<?php
    ...
    $html = '
        ...
        <h3 style="text-align:center">TRADITIONAL DRIVER</h3>
    ';
        ...
        <table style="border-collapse: collapse; width: 100%;">
            <thead>
                <tr>
                    ...
                    <th style="padding: 4px; text-align: center;border-bottom: 1px solid #ddd;">License</th>
    ...
    $fetch_data = mysqli_query($classDataBaseConnection->connect(), "SELECT * FROM staff_info_tbl WHERE sit_role_name ='TRA' ORDER BY sit_id DESC");
