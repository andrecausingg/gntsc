<?php
    ...
    $fetch_data = mysqli_query($classDataBaseConnection->connect(), "SELECT * FROM staff_info_tbl WHERE sit_role_name ='OPE' ORDER BY sit_id DESC");
        ...
        $html .= '
            <tbody>
                <tr>
                    ...
                    <td style="padding: 4px; text-align: center;border-bottom: 1px solid #ddd;">'. $db_sit_plate_num .'</td>
