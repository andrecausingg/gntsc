<?php
    ...
    class classDisplayDispatch{
        function displayDispatchCtToNova(){
            ...
            // DISPLAY
            $fetch_data = mysqli_query($classDataBaseConnection->connect(), "SELECT * FROM dispatch_tbl WHERE dt_route = 1 ORDER BY dt_id DESC");
        ...
        function displayNoActionDispatchCtToNova(){
            // File Connection Database
            require_once("./asset/php/helper/database-connection/connectionHF.php");
