...
class classSearch{
    ...
    function getSearch(){
        ...
        if($this->searchName != "" && $this->startDate !="" && $this->endDate){
            $query = " SELECT * FROM staff_info_tbl WHERE sit_datee BETWEEN '$searchStartDate' AND '$searchEndDate' AND (sit_surname LIKE '%".$search."%' OR sit_middlename LIKE '%".$search."%' OR sit_firstname LIKE '%".$search."%') AND sit_role_name ='PAO'";
            ...
            $query = " SELECT * FROM staff_info_tbl WHERE sit_datee = '$searchStartDate' AND (sit_surname LIKE '%".$search."%' OR sit_middlename LIKE '%".$search."%' OR sit_firstname LIKE '%".$search."%') AND sit_role_name ='PAO'";
            $result = mysqli_query($classDataBaseConnection->connect(), $query);
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    $db_sit_id = $row["sit_id"];
            ...
            $query = " SELECT * FROM staff_info_tbl WHERE sit_datee = '$searchEndDate' AND (sit_surname LIKE '%".$search."%' OR sit_middlename LIKE '%".$search."%' OR sit_firstname LIKE '%".$search."%') AND sit_role_name ='PAO'";
            $result = mysqli_query($classDataBaseConnection->connect(), $query);
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    $db_sit_id = $row["sit_id"];
            ...
            $query = " SELECT * FROM staff_info_tbl WHERE sit_datee BETWEEN '$searchStartDate' AND '$searchEndDate' AND sit_role_name ='PAO'";
            $result = mysqli_query($classDataBaseConnection->connect(), $query);
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    $db_sit_id = $row["sit_id"];
            ...
            $query = " SELECT * FROM staff_info_tbl WHERE (sit_surname LIKE '%".$search."%' OR sit_middlename LIKE '%".$search."%' OR sit_firstname LIKE '%".$search."%') AND sit_role_name ='PAO'";
            $result = mysqli_query($classDataBaseConnection->connect(), $query);
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    $db_sit_id = $row["sit_id"];
            ...
            $query = " SELECT * FROM staff_info_tbl WHERE sit_datee = '$searchStartDate' AND sit_role_name ='PAO'";
            $result = mysqli_query($classDataBaseConnection->connect(), $query);
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    $db_sit_id = $row["sit_id"];
            ...
            $query = " SELECT * FROM staff_info_tbl WHERE sit_datee '$searchEndDate' AND sit_role_name ='PAO'";
            $result = mysqli_query($classDataBaseConnection->connect(), $query);
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    $db_sit_id = $row["sit_id"];
            ...
            $query = " SELECT * FROM staff_info_tbl WHERE sit_role_name ='PAO'";
            $result = mysqli_query($classDataBaseConnection->connect(), $query);
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    $db_sit_id = $row["sit_id"];
