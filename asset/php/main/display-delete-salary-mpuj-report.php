<?php
    ...
    class classDisplayDelete{
        ...
        function displayDelete(){
            ...
            // DISPLAY
            $fetch_data = mysqli_query($classDataBaseConnection->connect(), "SELECT * FROM salary_mpuj_report WHERE smr_id = '$this->dataId' ");
            while($row = mysqli_fetch_assoc($fetch_data)){

                $smr_id = $row["smr_id"];
                $smr_pao_fullname = $row["smr_pao_fullname"];
                $smr_driver_fullname = $row["smr_driver_fullname"];
                ...
                echo'
                    ...
                    <div class="deleteContainer dashboard-edit-update-container yot-bg-rapsody-blue yot-tc-white yot-text-center"  style="border-radius:8px">
                        ...
                        <h4 class="yot-mb-8">'. "PAO: " .$smr_pao_fullname .'</h4>
                        <h4 class="yot-mb-16">'. "PUJ: "  .$smr_driver_fullname .'</h4>

                        <div class="yot-flex yot-flex-ai-c-jc-c">
                            <div class="yot-text-center yot-mr-8">
                                <form id="formDelete">
                                    <input style="font-size: 20px;" class="yot-btn-primary" id="dataIdDelete" type="hidden" value="'. $smr_id .'">
