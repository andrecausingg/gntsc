<?php
    if(isset($_POST["dataId"]) && isset($_POST["roleName"]) && isset($_POST["lastName"]) && isset($_POST["middleName"]) && isset($_POST["firstName"]) && isset($_POST["birthMonth"]) && isset($_POST["birthDay"]) && isset($_POST["birthYear"]) && isset($_POST["birthPlace"]) && isset($_POST["gender"]) && isset($_POST["civilStatus"]) && isset($_POST["address"]) && isset($_POST["contactNumber"]) && isset($_POST["plateNum"])){
        $classUpdatePuj = new classUpdatePuj($_POST["dataId"], $_POST["roleName"], $_POST["lastName"], $_POST["middleName"], $_POST["firstName"], $_POST["birthMonth"], $_POST["birthDay"], $_POST["birthYear"], $_POST["birthPlace"], $_POST["gender"], $_POST["civilStatus"], $_POST["address"], $_POST["contactNumber"], $_POST["plateNum"]);
    ...
    class classUpdatePuj{
        ...
        // Methods
        function __construct($dataId, $roleName, $lastName, $middleName, $firstName, $birthMonth, $birthDay, $birthYear, $birthPlace, $gender, $civilStatus, $address, $contactNumber, $plateNum){
            $this->dataId = $dataId;
                ...
                while($row = mysqli_fetch_assoc($fetch_data)){
                    ...
                    while($row = mysqli_fetch_assoc($fetch_data)){
                        ...
                        if($this->lastName != $row["sit_surname"] && $this->middleName != $row["sit_middlename"] && $this->firstName != $row["sit_firstname"] 
                            ...
                            && $this->address != $row["sit_address"] && $this->contactNumber != $row["sit_contact_num"] && $this->plateNum != $row["sit_plate_num"]){
                            ...
                            . "| and |Plate No. = " . $row["sit_plate_num"] . " to " . $this->plateNum 
                            ."| on";
                            ...
                            if($query_insert){
                                // Update Code
                                $query_update = mysqli_query($classDataBaseConnection->connect(),"UPDATE staff_info_tbl SET sit_role_name = '$this->roleName', sit_plate_num = '$this->plateNum', sit_surname = '$this->lastName', sit_middlename =  '$this->middleName', sit_firstname = '$this->firstName', sit_birthdate = '$birthdate', sit_birth_day = '$this->birthDay', sit_birth_month = '$this->birthMonth', sit_birth_year = '$this->birthYear', sit_birthplace = '$this->birthPlace', sit_gender = '$this->gender', sit_civil_status = '$this->civilStatus', sit_address = '$this->address', sit_contact_num = '$this->contactNumber' WHERE sit_id ='$this->dataId'");
                                if($query_update){
                                    echo "Success Update";
                                }
                            }
                        ...
                        }else if($this->lastName != $row["sit_surname"] && $this->plateNum != $row["sit_plate_num"]){
                        ...
                        }else if($this->middleName != $row["sit_middlename"] && $this->plateNum != $row["sit_plate_num"]){
                        ...
                        }else if($this->firstName != $row["sit_firstname"] && $this->plateNum != $row["sit_plate_num"]){
                        ...
                        }else if($this->birthMonth != $row["sit_birth_month"] && $this->plateNum != $row["sit_plate_num"]){
                        ...
                        }else if($this->birthDay != $row["sit_birth_day"] && $this->plateNum != $row["sit_plate_num"]){
                            $description = "|ROLE = $this->roleName |" . $fullName . " change data of |Birth Day = " . $row["sit_birth_day"] . " to " . $this->birthDay 
                            . "| and |Plate No. = " . $row["sit_plate_num"] . " to " . $this->plateNum 
                            ."| on";
                        ...
                        }else if($this->birthPlace != $row["sit_birthplace"] && $this->plateNum != $row["sit_plate_num"]){
                        ...
                        }else if($this->civilStatus != $row["sit_civil_status"] && $this->plateNum != $row["sit_plate_num"]){
                            $description = "|ROLE = $this->roleName |" . $fullName . " change data of |Civil Status = " . $row["sit_civil_status"] . " to " . $this->civilStatus 
                            . "| and |Plate No. = " . $row["sit_plate_num"] . " to " . $this->plateNum 
                            ."| on";
                        ...
                        else if($this->address != $row["sit_address"] && $this->contactNumber != $row["sit_contact_num"] && $this->plateNum != $row["sit_plate_num"]){
                        ...
                        }else if($this->address != $row["sit_address"] && $this->plateNum != $row["sit_plate_num"]){
                        ...
                        else if($this->contactNumber != $row["sit_contact_num"] && $this->plateNum != $row["sit_plate_num"]){
                        ...
                        else if($this->plateNum != $row["sit_plate_num"]){

                            $description = "|ROLE = $this->roleName |" . $fullName . " change data of |Plate No. = " . $row["sit_plate_num"] . " to " . $this->plateNum ."| on";
